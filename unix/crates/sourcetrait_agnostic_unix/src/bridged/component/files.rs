...
impl agnostic::FilesComponentLookup for UnixFilesComponentLookup {
    fn copy_preserved_with<P1, P2>(&self, src: P1, dst: P2, opts: impl AsRef<FsOptions>) -> agnostic::BridgeResult<()>
    where
        P1: AsRef<Path>,
        P2: AsRef<Path>
    {
